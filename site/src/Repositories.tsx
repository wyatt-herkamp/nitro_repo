...
export function NewRepo() {
    ...
    const newRepoRequest = async event => {
        ...
        const res = await fetch(
            API_URL + "/api/admin/repository/add",
            {
                body: body,
                headers: {
    ...
    return (<form className={classes.form} noValidate onSubmit={newRepoRequest} >
        <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
                <FormControl variant="outlined" className={classes.formControl}>
                    <InputLabel id="demo-simple-select-outlined-label">Repo Type</InputLabel>
                    <Select
            ...
            <Grid item xs={12}>
                <FormControl variant="outlined" className={classes.formControl}>
                    <InputLabel id="demo-simple-select-outlined-label">Storage</InputLabel>
                    <Select
                        labelId="demo-simple-select-outlined-label"
                        id="storage"
                        label="storage"
